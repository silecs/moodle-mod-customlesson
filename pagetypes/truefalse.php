...
class customlesson_page_type_truefalse extends customlesson_page {
    ...
    public function display($renderer, $attempt) {
        ...
        $mform = new customlesson_display_answer_form_truefalse($CFG->wwwroot.'/mod/customlesson/continue.php', $params);
        $data = new stdClass;
        $data->id = $PAGE->cm->id;
...
class customlesson_add_page_form_truefalse extends customlesson_add_page_form_base {
